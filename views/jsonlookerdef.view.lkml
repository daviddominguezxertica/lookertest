# The name of this view in Looker is "Jsonlookerdef"
view: jsonlookerdef {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `AndresD_Test.JSONLOOKERDEF`
    ;;
...
# The name of this view in Looker is "Jsonlookerdef Items"
view: jsonlookerdef__items {
  # No primary key is defined for this view. In order to join this view in an Explore,
  # define primary_key: yes on a dimension that has no repeated values.

  # Here's what a typical dimension looks like in LookML.
  # A dimension is a groupable field that can be used to filter query results.
  # This dimension will be called "Jsonlookerdef Items" in Explore.

  dimension: jsonlookerdef__items {
    type: string
    sql: jsonlookerdef__items ;;
  }
}

# The name of this view in Looker is "Jsonlookerdef Event Params"
view: jsonlookerdef__event_params {
  # No primary key is defined for this view. In order to join this view in an Explore,
  # define primary_key: yes on a dimension that has no repeated values.
  ...
  dimension: jsonlookerdef__event_params {
    type: string
    hidden: yes
    sql: jsonlookerdef__event_params ;;
  }
...
# The name of this view in Looker is "Jsonlookerdef User Properties"
view: jsonlookerdef__user_properties {
  # No primary key is defined for this view. In order to join this view in an Explore,
  # define primary_key: yes on a dimension that has no repeated values.
  ...
  dimension: jsonlookerdef__user_properties {
    type: string
    hidden: yes
    sql: jsonlookerdef__user_properties ;;
  }
